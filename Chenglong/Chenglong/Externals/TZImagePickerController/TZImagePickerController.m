...
- (void)viewDidLoad {
    ...
    if (iOS7Later) {
        ...
        self.navigationBar.tintColor = [UIColor kaishiColor:UIColorTypeThemeSelected];
    ...
    textAttrs[NSForegroundColorAttributeName] = [UIColor kaishiColor:UIColorTypeThemeSelected];
...
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount delegate:(id<TZImagePickerControllerDelegate>)delegate {
    ...
    if (self) {
        self.maxImagesCount = maxImagesCount > 0 ? maxImagesCount : 10; // Default is 10 / 默认最大可选9张图片
        ...
        if (![[TZImageManager manager] authorizationStatusAuthorized]) {
            ...
            _tipLable.font = [UIFont type:UIFontTypeNormal size:16.0];
            _tipLable.textColor = [UIColor grayLevelColor:UIColorGray5];
...
- (void)observeAuthrizationStatusChange {
    if ([[TZImageManager manager] authorizationStatusAuthorized]) {
        ...
        TZAlbumPickerController* pickerController = self.viewControllers.firstObject;
        [pickerController configTableView];
    }
}
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    if (self.childViewControllers.count > 0) {
        ...
        [backButton setImage:[[UIImage imageNamed:@"navi_back"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
        backButton.tintColor = [UIColor kaishiColor:UIColorTypeThemeSelected];
        backButton.imageEdgeInsets = UIEdgeInsetsMake(0, -5, 0, 0);
        [backButton setTitleColor:[UIColor kaishiColor:UIColorTypeThemeSelected] forState:UIControlStateNormal];
