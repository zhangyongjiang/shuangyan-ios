...
- (void)configBottomToolBar {
    ...
    _previewButton.titleLabel.font = [UIFont type:UIFontTypeLight size:16.0];
    [_previewButton setTitle:@"预览" forState:UIControlStateNormal];
    [_previewButton setTitle:@"预览" forState:UIControlStateDisabled];
    [_previewButton setTitleColor:[UIColor grayLevelColor:UIColorGray5] forState:UIControlStateNormal];
    [_previewButton setTitleColor:[UIColor lightGrayColor] forState:UIControlStateDisabled];
    _previewButton.enabled = NO;
    
    _okButton = [UIButton buttonWithType:UIButtonTypeCustom];
    _okButton.frame = CGRectMake(self.view.width - 44 - 12, 3, 44, 44);
    _okButton.titleLabel.font = [UIFont type:UIFontTypeNormal size:16.0];
    ...
    [_okButton setTitleColor:[UIColor themeColor:UIColorTypePrimary] forState:UIControlStateNormal];
    [_okButton setTitleColor:[UIColor lightGrayColor] forState:UIControlStateDisabled];
    _okButton.enabled = NO;
    
    _numberImageView = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"photo_number_icon"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]];
    _numberImageView.frame = CGRectMake(self.view.width - 56 - 24, 12, 26, 26);
    _numberImageView.tintColor = [UIColor themeColor:UIColorTypePrimary];
    _numberImageView.hidden = _selectedPhotoArr.count <= 0;
    _numberImageView.backgroundColor = [UIColor clearColor];
    
    _numberLable = [[UILabel alloc] init];
    _numberLable.frame = _numberImageView.frame;
    _numberLable.font = [UIFont type:UIFontTypeLight size:16.0];;
    ...
    cell.didSelectPhotoBlock = ^(BOOL isSelected) {
        ...
        if (isSelected) {
            ...
            if (weakSelf.selectedPhotoArr.count < imagePickerVc.maxImagesCount) {
                ...
                [imagePickerVc showAlertWithTitle:[NSString stringWithFormat:@"最多选择%ld张图片",imagePickerVc.maxImagesCount]];
            }
        }
