...
- (void)setModel:(TZAssetModel *)model {
    ...
    self.selectImageView.image = self.selectPhotoButton.isSelected ? [UIImage imageNamed:@"photo_sel_photoPickerVc_pink"] : [UIImage imageNamed:@"photo_def_photoPickerVc"];
...
- (IBAction)selectPhotoButtonClick:(UIButton *)sender {
    ...
    self.selectImageView.image = sender.isSelected ? [UIImage imageNamed:@"photo_sel_photoPickerVc_pink"] : [UIImage imageNamed:@"photo_def_photoPickerVc"];
...
- (void)setModel:(TZAlbumModel *)model {
    ...
    NSMutableAttributedString *nameString = [[NSMutableAttributedString alloc] initWithString:model.name attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:16],NSForegroundColorAttributeName:[UIColor grayLevelColor:UIColorGray5]}];
