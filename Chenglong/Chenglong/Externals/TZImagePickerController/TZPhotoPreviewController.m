...
- (void)configCustomNaviBar {
    ...
    _naviBar.backgroundColor = [UIColor colorWithWhite:0.0 alpha:1.0];
    _naviBar.alpha = 0.5;
    ...
    [_selectButton setImage:[UIImage imageNamed:@"photo_sel_photoPickerVc_pink"] forState:UIControlStateSelected];
